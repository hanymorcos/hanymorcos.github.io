  ...
  [337],
  {
    ...
    8634: function (b, a) {
      ...
      a.Z = [
        {
          id: 87190989,
          name: 'typescript-express-inversify-typeorm-mysql',
          htmlUrl:
            'https://github.com/hanymorcos/typescript-express-inversify-typeorm-mysql',
          homepage: '',
          description: 'Typescript web application example',
          language: 'TypeScript',
          forksCount: 5,
          stargazersCount: 6,
          topics: [
          ...
          createdAt: '2017-04-04T13:37:58Z',
          updatedAt: '2022-02-01T14:52:23Z',
        },
      ]
    },
    355: function (e, b, a) {
      ...
      function o(b) {
        ...
        return (0, g.jsx)('span', {
          className: n().dot,
          style: {
            background: null !== (a = m[c]) && void 0 !== a ? a : 'initial',
          },
        })
      }
      var p = a(6010)
      function q(b) {
        ...
        return (0, g.jsxs)('article', {
          className: (0, p.Z)(h().repo, (0, f.Z)({}, h().paper, d)),
          children: [
            (0, g.jsxs)('div', {
              className: h().header,
              children: [
                  ...
                  children: [
                    ...
                    a.homepage &&
                      (0, g.jsx)(i.Z, {
                        ...
                        children: (c = a.homepage).includes('npmjs.com')
                          ? (0, g.jsx)(l.HKf, {})
                          : (0, g.jsx)(k.AlO, {}),
                      }),
                  ],
            ...
            (0, g.jsxs)('div', {
              ...
              children: [
                (0, g.jsx)(i.Z, {
                  href: a.htmlUrl,
                  className: h().link,
                  'aria-label': 'Read more about '.concat(a.name, ' on GitHub'),
                  children: (0, g.jsx)('span', {
                    className: h().title,
                    children: a.name,
                  }),
                }),
                (0, g.jsx)('p', { children: a.description }),
              ],
            }),
            (0, g.jsxs)('div', {
              className: h().footer,
              children: [
                a.language &&
                  (0, g.jsxs)('div', {
                    className: h().label,
                    children: [
                      (0, g.jsx)(o, { language: a.language }),
                      (0, g.jsx)('span', { children: a.language }),
                    ],
                  }),
                a.stargazersCount > 0 &&
                  (0, g.jsx)(i.Z, {
                    href: a.htmlUrl,
                    className: h().labelLink,
                    'aria-label': 'Give '.concat(a.name, ' a star on GitHub'),
                    children: (0, g.jsxs)('div', {
                      className: h().label,
                      children: [
                        (0, g.jsx)(j.ObP, {}),
                        (0, g.jsx)('span', { children: a.stargazersCount }),
                      ],
                    }),
                  }),
                a.forksCount > 0 &&
                  (0, g.jsx)(i.Z, {
                    href: a.htmlUrl,
                    className: h().labelLink,
                    'aria-label': 'Fork '.concat(a.name, ' on GitHub'),
                    children: (0, g.jsxs)('div', {
                      className: h().label,
                      children: [
                        (0, g.jsx)(j.bLi, {}),
                        (0, g.jsx)('span', { children: a.forksCount }),
                      ],
                    }),
                  }),
              ],
    ...
    3684: function (d, b, a) {
      ...
      function l() {
        return (0, e.jsx)(g.Z, {
          ...
          description:
            'Hany Morcos enjoys building meaningful products and open source software that has an impact in the world.',
          url: ''.concat(h.Z.home, '/work'),
          image: h.Z.heroImage,
          imageWidth: '1411',
          imageHeight: '682',
          children: (0, e.jsx)('div', {
            ...
            children: (0, e.jsxs)('main', {
              ...
              children: [
                ...
                (0, e.jsx)('h2', { children: 'A pinch of awesomeness' }),
                (0, e.jsx)('p', {
                  children:
                ...
                (0, e.jsxs)('div', {
                  ...
                  children: [
                    (0, e.jsxs)('div', {
                      className: f().projectDescription,
                      children: [
                        (0, e.jsx)('h3', {
                    ...
                    (0, e.jsx)('div', {
                      ...
                      children: (0, e.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, e.jsx)('div', { className: f().imageShadow }),
                        ],
                      }),
                    }),
                  ],
                      ...
                      'section',
                      {
                        ...
                        children: [
                          (0, e.jsx)('div', {
                            ...
                            children: (0, e.jsx)('div', {
                              className: f().tags,
                              children: a.topics.map(function (b) {
                                return (0,
                                e.jsx)('span', { className: f().tag, children: b }, ''.concat(a.id, '-').concat(b))
                              }),
                            }),
                          }),
                          (0, e.jsx)('div', {
                            className: f().focal,
                            children: (0, e.jsx)(j.Z, { repo: a }),
                          }),
                        ],
                      },
                      a.id
    ...
    4244: function (a) {
      a.exports = {
        container: 'Work_container__1W05v',
        main: 'Work_main__fHfnL',
        grid: 'Work_grid__NPwBS',
        support: 'Work_support__UQib8',
        focal: 'Work_focal__9JAY1',
        tags: 'Work_tags__mueX_',
        tag: 'Work_tag__7qRs5',
        link: 'Work_link__szhLh',
        project: 'Work_project__QlkmQ',
        projectDescription: 'Work_projectDescription__VjI1E',
        imageContainer: 'Work_imageContainer__vnJK4',
        image: 'Work_image__gQMtv',
        imageShadow: 'Work_imageShadow__ski2B',
        cfa: 'Work_cfa__q9JUf',
        repos: 'Work_repos__cqXVR',
      }
    },
  },
  function (a) {
    a.O(0, [937, 297, 774, 888, 179], function () {
      var b
      return a((a.s = 8953))
    }),
      (_N_E = a.O())
